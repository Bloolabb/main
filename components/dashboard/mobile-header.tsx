      ...
      <div className="flex items-center justify-between p-4">
        ...
        <div className="flex items-center gap-2">
          <div className="relative">
            <div className="w-8 h-8 bg-linear-to-br from-purple-600 to-blue-600 rounded-xl flex items-center justify-center shadow-lg">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1.5 bg-linear-to-r from-purple-500/10 to-blue-500/10 px-3 py-1.5 rounded-full border border-purple-200 dark:border-purple-800">
          ...
          <div className="flex items-center gap-1.5 bg-linear-to-r from-orange-500/10 to-red-500/10 px-3 py-1.5 rounded-full border border-orange-200 dark:border-orange-800">
